...
/// <see cref="ContentAnalyse.Context"/> or not. It can be null or empty if <see cref="HasError"/>.</param>
...
/// displayed message comes exclusively from the external Api and not from Lensophy. Whenever <see cref="HasError"/>,
